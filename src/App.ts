...
class App {
  ...
  private routes(): void {
    ...
    workers.initWorkers([{
      ...
      search1: ['BTC'],
      search2: ['LTC', 'DOGE'],
      search3: ['ETN', 'LUX', 'BITG', 'ADC', 'ANON', 'QAC', 'GRFT', 'PRJ', 'LINDA', 'GTM', 'VITAE', 'DBIX', 'DAPS', 'ETH', 'TPAY', 'LGS', 'TOA', 'PRG', 'PENG', 'UNIT', 'DOGE', 'DGB', 'RDD', 'XSN', 'XP', 'IVY', 'ECA', 'XCASH', 'XMR', 'PHO', 'DIME', 'CTL', 'ARC'],
      ...
      tradePercent: 60, //Trade 40 % of balance everytime when there's opportunity

      search1: ['BTC'],
      search2: ['ETH', 'DOGE', 'WAVES'],
      search3: ['DOGE', 'WIT', 'SATO', 'AGR', 'LTC', 'PLC', 'NOAH', 'RNTB', 'FTO', 'NYC', 'ETH', '$PAC', 'TOKEN', 'DASH', 'WAVES', 'LSK', 'CAT', 'SMART', 'TRX', 'LIZA', 'BNB', 'BCA', 'MDZ', 'BCC', 'ZEC'],
